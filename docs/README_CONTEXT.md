...
- `boot/active/boot_pack/context_pack.json` is the index of active pointers.
- The rest of the pack lives alongside it in `boot/active/boot_pack/`.

## How to keep it current
- When docs move, update `boot/active/boot_pack/context_pack.json` to point at the new locations.
- Keep `boot/active/boot_pack/RESURRECTION.md` aligned with current workflow and repo-gates.
